...
class JoomlaMigration(models.TransientModel):
    ...
    to_website_id = fields.Many2one('website', default=lambda self: self._default_to_website(), required=True)
    to_blog_id = fields.Many2one('blog.blog', default=lambda self: self._default_to_blog(), required=True)
    to_forum_id = fields.Many2one('forum.forum', default=lambda self: self._default_to_forum(), required=True)
